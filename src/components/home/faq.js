      ...
      <div className="container-fluid">
        ...
        <Collapse defaultActiveKey={['1']}>
          <Panel header="Why I can't see the camera, even though i allow the access permission?" key="1">
            <p>Usually it takes seconds for the camera to appear, if it takes longer than minutes Please refresh the page .</p>
          ...
          <Panel header="Why is there no detection?" key="2">
            <p>It takes an average of 2 minutes to fetch and load the model.</p>
			<p> If you are using from the mobile please use landscape mode and if doesn't work the mobile view has limited support versions from the tensorflowjs libary</p>
